...
We've also added new trait override APIsto easily modify trait values on any view or view controller.
...
UIPageControlTimerProgress has a built-in timerto make it easy to configure each page's duration.
